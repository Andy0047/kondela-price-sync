...
// ===================== CONFIG =====================
const CONFIG = [
    'sourceUrl'        => 'https://b2b.kondela.sk/feed/kuchyna_jedalen_cz.xml',
    //'sourceUrl'        => 'https://dev.prodboard.com/clients/kondela/test.xml',
    'cacheFile'        => __DIR__ . '/kondela_price_cache_cz.json',
    'logFile'          => __DIR__ . '/kondela_price_sync_cz.log',
    'company'          => '',
    'privateKey'       => '',
    'apiBase'          => 'https://api-v2.prodboard.com',
    'priceListCode'    => 'price_czk',
    'batchLimit'       => 100,
    'batchPauseMs'     => 200,
    'timeoutSeconds'   => 30,
    'verifySSL'        => true,
